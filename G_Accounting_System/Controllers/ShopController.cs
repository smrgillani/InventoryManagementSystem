...
namespace G_Accounting_System.Controllers
{
    ...
    public class ShopController : Controller
    {
        ...
        public JsonResult GetAllPremises(string Search)
        {
            ...
            List<Premisess> premises = new Catalog().AllShops(search.Option, search.Search, search.StartDate, search.EndDate);
        ...
        public JsonResult SendRequestToDelPremises(string DeletePremisesData)
        {
            ...
            try
            {
                ...
                if (premises.Count != 0)
                {
                    ...
                    System.IO.File.WriteAllText(Server.MapPath("~/CSV/Shops/" + filename), fileContent.ToString());

                    DirectoryInfo dir = new DirectoryInfo(Server.MapPath("~/CSV/Shops/"));
