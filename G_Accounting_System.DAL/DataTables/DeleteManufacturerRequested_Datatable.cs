...
{
    class DeleteManufacturerRequested_Datatable
    {
        public DataTable DataTable { get; private set; }
        public DeleteManufacturerRequested_Datatable()
        {
            DataTable = new DataTable();
            DataTable.Columns.Add(new DataColumn("Manufacturer_id", typeof(int)) { AllowDBNull = true });
        ...
        public void FillDataTable(List<Manufacturers> list)
        {
            ...
            foreach (var currentObj in list)
            {
                ...
                currentRow["Manufacturer_id"] = currentObj.id;
