...
{
    class DeleteSalesRequested_Datatable
    {
        public DataTable DataTable { get; private set; }
        public DeleteSalesRequested_Datatable()
        {
        ...
        public void FillDataTable(List<SalesOrders> list)
        {
            ...
            foreach (var currentObj in list)
            {
                ...
                currentRow["id"] = currentObj.SalesOrder_id;
