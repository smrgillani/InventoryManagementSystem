...
{
    class DeleteUnitRequested_Datatable
    {
        public DataTable DataTable { get; private set; }
        public DeleteUnitRequested_Datatable()
        {
            DataTable = new DataTable();
            DataTable.Columns.Add(new DataColumn("Unit_id", typeof(int)) { AllowDBNull = true });
        ...
        public void FillDataTable(List<Units> list)
        {
            ...
            foreach (var currentObj in list)
            {
                ...
                currentRow["Unit_id"] = currentObj.id;
